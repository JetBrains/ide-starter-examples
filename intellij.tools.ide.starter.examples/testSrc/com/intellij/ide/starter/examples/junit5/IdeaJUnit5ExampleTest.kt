...
import com.intellij.ide.starter.examples.data.GoLandCases
import com.intellij.ide.starter.examples.data.IdeaUltimateCases
import com.intellij.ide.starter.examples.data.PyCharmCases
...
class IdeaJUnit5ExampleTest {
  ...
  fun openGoProjectInGoLand() {
    val testContext = Starter
      .newContext(CurrentTestMethod.hyphenateWithClass(), GoLandCases.Gvisor)
    testContext.runIDE(commands = CommandChain().exitApp())
  }
}