...
dependencies {
  ...
  testImplementation("com.jetbrains.intellij.tools:ide-starter-product-goland:LATEST-EAP-SNAPSHOT")
  testImplementation("com.jetbrains.intellij.tools:ide-starter-product-pycharm:LATEST-EAP-SNAPSHOT")
  testImplementation("com.jetbrains.intellij.tools:ide-starter-product-android-studio:LATEST-EAP-SNAPSHOT")
